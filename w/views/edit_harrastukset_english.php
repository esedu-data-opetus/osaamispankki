...
<head>
	<meta charset="utf-8">
	<title>Hobbies</title>
	<h1 style="text-align:center;font-weight:bold;">Hobbies</h1><br>
...
$inputvapaasana = array('value'   =>''.$vapaasana.'',
	...
	echo form_open('sivu/edit_harrastukset_english/'.$id.'');
	...
	echo "<br>";
	echo "<br>";
	echo form_submit('submit', 'Update hobby', 'id="nappi"');
	echo '</div>';
