...
if (isset($_GET['Prof_Edit'])) {
  if ($_GET['Prof_Edit'] == $User->User_id) {
    ...
    $btn2     = '<input style="width: 0; float: right; border-top-right-radius: 0; border-bottom-right-radius: 0; border-top-left-radius: 0; border-bottom-left-radius: 0;" onClick="location.reload();" type="button" id="save_btn" class="btn btn-primary" value="Peruuta" title="Peruuta"/>';
  } else {
