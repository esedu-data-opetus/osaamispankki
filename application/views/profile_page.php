...
<div class="panel panel-default">
  <div class="panel-heading">
    ...
    <?php endif; ?>
    <div class="input-text"><h1 style="text-align: center; margin: 0; padding: 0; display: inline;">Metatieto</h1><span class="glyphicon glyphicon-question-sign info"></span><span class="info-text">Metatiedot ovat hakusanoja joilla profiilisi on helpommin löydettävissä esimerkiksi haussa.</span></div>
    </div>
    <div class="panel-body">
