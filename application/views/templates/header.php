    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      ...
      <?php if ($this->session->userdata('is_logged_in') !== 1) :?>
        ...
        <li><div class="btn-group">
          ...
          <a class="btn btn-primary btn-lg <?php echo $disabled; ?>" style="margin: 10px 0 0 0; padding: 13px 0 13px 0;" href="Ajax_test"><span class="glyphicon glyphicon-globe"></span></a>
