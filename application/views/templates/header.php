    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      ...
      <?php if ($this->session->userdata('is_logged_in') !== 1) :?>
        ...
        <li><div class="btn-group">
          ...
          <a href="<?php echo base_url(); ?>Profile/Settings" class="btn btn-primary" style="padding: 15px 10px 15px 10px; margin: 10px 10px 10px -1px;"><span class="glyphicon glyphicon-cog"></span></a>
        </div></li>
      <?php else : ?>
