    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      ...
      <?php if ($this->session->userdata('is_logged_in') !== 1) :?>
        ...
        <li><div class="btn-group">
          ...
          <a href="<?php echo base_url(); ?>Profile/Settings/<?php echo $this->session->userdata('user_id'); ?>" class="btn btn-primary" style="padding: 15px 10px 15px 10px; margin: 10px 10px 10px -1px;"><span class="glyphicon glyphicon-cog"></span></a>
        </div></li>
      <?php else : ?>
      ...
      <?php if ($this->session->userdata('KT') == 3) :?>
        ...
        <li><a class="btn btn-info btn-lg <?php echo $disabled; ?>" style="color: white; margin: 10px;" href="<?php echo base_url(); ?>Home/Admin"><span class="glyphicon glyphicon-list"></span> Käyttäjät</a></li>
      <?php else : ?>
