...
public function getUserfname($sposti) {
  ...
  public function share($us_id, $email, $sposti, $fname) {
    $message = "<p>".$fname." jakoi profiilinsa. Profiiliin pääset <a href='".base_url()."Haku/User/".$us_id."/".md5($sposti)."' >tästä</a>!</p>";
