...
public function getUsername() {
  ...
  public function share($us_id, $email, $sposti, $F_Name, $L_Name) {
    $message = "<p>".$F_Name." ".$L_Name." jakoi profiilinsa. Profiiliin pääset <a href='".base_url()."Haku/User/".$us_id."/".md5($sposti)."' >tästä</a>!</p>";
