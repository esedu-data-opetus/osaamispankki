...
function change_password($userid, $password) {
	...
	mysqli_query($GLOBALS["___mysqli_ston"], "UPDATE user SET password = '$password' WHERE userid = $userid");
...
function user_exists($tunnus) {
	...
	$result = mysqli_query($GLOBALS["___mysqli_ston"], "SELECT userID FROM kayttajat WHERE tunnus = '$tunnus' ");
