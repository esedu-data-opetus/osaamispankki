...
<form> 
  ...
  <div class="form-group">
    <label for="exampleInputPassword1">Salasana uudestaan</label>
    <input type="password" class="form-control" id="exampleInputPassword1" placeholder="Salasana uudestaan">
  </div>

  <br>
  
  <input type="submit" class="btn btn-default" value="Rekisteröidy!">
</form>
<?php
} else {
  print_r( $_POST );
