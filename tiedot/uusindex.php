      ...
      <div class="container">
        ...
        <div id="navbar" class="navbar-collapse collapse">
          ...
          <ul class="nav navbar-nav navbar-right">
            ...
            <li><a href="../changepassword.php"><button type="button" class="btn btn-primary" style="width:110px; height:25px;  padding:0px;" >Vaihda Salasana </button></a></li>
          </ul>
        </div><!--/.nav-collapse -->
      </div>
    </nav>
...
if (isset($_FILES['profile']) === true) {
    if (empty($_FILES['profile']['name']) === true) {
        ...
        if (in_array($file_extn, $allowed) === true ) {
            change_profile_image($hloID, $file_temp, $file_extn);
            
        } else {
            echo 'Väärä tiedosto tyyppi. Sallitut: ';
...
if (empty($row['profile']) === false) {
    echo '<img src="', $row['profile'], '" alt="',  $row['eNimi'], '\n Profiili Kuva ">';
}    
?>
